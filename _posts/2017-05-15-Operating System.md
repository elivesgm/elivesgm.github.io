...
ELF(Executable and Linking Format)是一种对象文件的格式，具体参见“[Executable and Linking Format (ELF) Files](/_posts/2017-05-18-Executable and Linking Format File.md)”。
